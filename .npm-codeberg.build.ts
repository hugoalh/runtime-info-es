...
await invokeDenoNodeJSTransformer({
	...
	metadata: {
		...
		homepage: "https://codeberg.org/hugoalh/runtime-info-es#readme",
		bugs: {
			url: "https://codeberg.org/hugoalh/runtime-info-es/issues"
		},
		license: "MIT",
		author: "hugoalh",
		repository: {
			type: "git",
			url: "git+https://codeberg.org/hugoalh/runtime-info-es.git"
		},
		private: false,
		publishConfig: {
			access: "public"
